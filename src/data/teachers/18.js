...
export const teacherInfo = {
  ...
  personalInfo: {
    ...
    // Automate generator
    otherInfo: `Образование: МГУ им. М.В. Ломоносова, химический факультет, специальность – медицинская химия (2008 г.); факультет педагогического образования МГУ, слушатель.
    Призёр региональных и всероссийских олимпиад по химии и биологии.
    Лауреат конкурсов научных работ для молодых ученых.
