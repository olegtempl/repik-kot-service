...
export const teacherInfo = {
  ...
  personalInfo: {
    ...
    // Automate generator
    otherInfo: `Образование: МГУ им. М.В. Ломоносова, факультет фундаментальной медицины (2003 г.).
    Опыт репетиторства – с 2000 года.
    Участница вебинаров компании «Ваш репетитор».

    Я стараюсь с каждым учеником достичь максимального результата. Работаю с любым уровнем, ОГЭ, ЕГЭ, ДВИ, готовлю как на 90-100 баллов, так и для поступления на второе высшее/контрактную основу. Каждому подбираю оптимальный план подготовки, в том числе при занятиях в мини-группе.

    ДВИ в МГУ – только индивидуальные занятия, для учеников с высоким уровнем знаний.

    Всем ученикам предоставляется доступ к LMS – iSpring online c авторскими материалами и онлайн-тестами.`,
    firstName: 'Эма',
