...
export const teacherInfo = {
	...
	personalInfo: {
		...
		// Automate generator
		otherInfo: `Кандидат химических наук (1986 г.).
    Образование: МГУ им. М.В. Ломоносова, специальность – химия (диплом с отличием, 1979 г.); аспирантура МГУ.
    Опыт преподавания – 5 лет (доцент в ряде ВУЗов Москвы и Подмосковья, руководитель частного репетиторского центра).
    Опыт репетиторства – 30 лет.`,
		firstName: 'Яугенiя',
