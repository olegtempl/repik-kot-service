...
export const teacherInfo = {
  ...
  personalInfo: {
    ...
    // Automate generator
    otherInfo: `Кандидат химических наук, доцент.
    Образование: Российский химико-технологический университет им. Д.И. Менделеева (РХТУ), специальность – химик.
    Доцент, преподаватель общей, неорганической и аналитической химии Московской государственной академии ветеринарной медицины и биотехнологии им. К.И. Скрябина (МГАВМиБ).
    Опыт репетиторства – 25 лет.`,
    firstName: 'Кастусь',
