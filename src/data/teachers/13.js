...
export const teacherInfo = {
  ...
  personalInfo: {
    ...
    // Automate generator
    otherInfo: `Образование:
    2005 — МГУ им. М.В. Ломоносова, химический факультет.
    2011 — Кандидат химических наук.
    2015 — Южный федеральный университет, диплом магистра юриспруденции с отличием.
    Опыт:
    2005–н.в. — Репетиторская деятельность.
    2005–2011 — Младший научный сотрудник; научный сотрудник химического факультета МГУ (с 2012 г.).
    В 2014 и 2016 годах сдал ЕГЭ по химии на 100 баллов.
    С 2017 года официально зарегистрированный репетитор – индивидуальный предприниматель.`,
    firstName: 'Вітаўтас',
